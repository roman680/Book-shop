...
@Sql(scripts = {
        "classpath:db/categories/insert-categories-into-categories-table.sql",
        "classpath:db/book/insert-books-into-books-table.sql",
        "classpath:db/categories/insert-into-books-categories-table.sql"
}, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
@Sql(scripts = {
        "classpath:db/categories/delete-from-books-categories-table.sql",
        "classpath:db/categories/delete-categories-from-categories-table.sql",
