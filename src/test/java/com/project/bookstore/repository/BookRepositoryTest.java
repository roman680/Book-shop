...
@Sql(scripts = {
        ...
        "classpath:db/categories/delete-category.sql",
        "classpath:db/categories/delete-book-categories.sql"
...
class BookRepositoryTest {
    ...
    static void beforeAll() {
        ...
        theGreatGatsbyBook.setPrice(new BigDecimal("100"));
        ...
        vanityFairBook.setPrice(new BigDecimal("90"));
